...
export class SomTrainQuery implements SomTrainQueryMessage {
  ...
  constructor(public readonly size: number, public readonly retriever_knn: string, public readonly retriever_som: string, public readonly deepness: number, public readonly positives: string[], public readonly negatives: string[], public readonly config: QueryConfig = null) {
  }
}