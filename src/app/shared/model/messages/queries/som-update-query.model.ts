...
export class SomUpdateQuery implements SomTrainQueryMessage {
  ...
  constructor(public readonly size: string, public readonly retriever: string, public readonly deepness: string, public readonly positives: string[], public readonly negatives: string[], public readonly config: QueryConfig = null) {
  }
}