...
export class SomUpdateQuery implements SomTrainQueryMessage {
  ...
  constructor(public readonly retriever: string, public readonly positives: string[], public readonly negatives: string[], public readonly config: QueryConfig = null) {
  }
}