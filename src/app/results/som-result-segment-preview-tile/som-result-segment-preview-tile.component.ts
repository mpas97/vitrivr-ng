 ...
 */
@Component({
  selector: 'som-result-segment-preview-tile',
  templateUrl: './som-result-segment-preview-tile.component.html',
  styleUrls: ['./som-result-segment-preview-tile.component.css']
})
export class SomResultSegmentPreviewTileComponent implements OnInit {
