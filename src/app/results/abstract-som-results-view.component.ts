...
import { ColorUtil } from 'app/shared/util/color.util';

export abstract class AbstractSomResultsViewComponent<T> implements OnInit, OnDestroy {
  ...
  public backgroundForScore(score: number, segment: SegmentScoreContainer): string {
    ...
    if (tags.length === 0) {
      return ColorUtil.rgbToHex(255, 255, 255);
