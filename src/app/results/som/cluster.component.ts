...
@Component({
  moduleId: module.id,
  selector: 'som-cluster',
  templateUrl: 'cluster.component.html',
  styleUrls: ['cluster.component.css'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class ClusterComponent extends AbstractSomSegmentResultsViewComponent<SegmentScoreContainer[]> {
    ...
    protected subscribe(results: ResultsContainer) {
        if (results) {
        this._dataSource = results.somClusterSegmentsAsObservable;
        }
    }
}
